...
<div class="col-lg-12">
	<div class="card">
		<div class="card-body">
			<h2 class="card-title">Tambah pemasukan</h2>
			<div class="basic-form">
				<form class="col-sm-8">
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Tanggal pemasukan</label>
						<div class="col-sm-7">
							<input type="text" class="form-control" placeholder="2017-06-04" id="mdate">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Pemasukan</label>
						<div class="col-sm-7">
					...
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Jumlah pemasukan</label>
						<div class="col-sm-7">
