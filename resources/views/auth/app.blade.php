    ...
    ***********************************-->
    ...
    <script type="text/javascript">
        ...
        $("#tambah_tipe").click(function(){
            var tipe = $("#nama_tipe").val();
            $("#show_tipe").append("<li class='list-group-item d-flex justify-content-between align-items-center'>"+tipe + "<a href='javascript:void(0)' id='delete_tipe'><span class='badge badge-danger badge-pill'>X</span></a></li>");
        });

        $("#show_tipe").on("click", "#delete_tipe", function(){
