			...
			<div class="basic-form">
				<form class="col-sm-8">
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Nama Jenis Pengeluaran</label>
						<div class="col-sm-7">
							<input type="text" class="form-control" name="nama" placeholder="Pengeluaran yg sering co: Makanan">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Tipe Pengeluaran</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="nama" id="nama_tipe" placeholder="detail Pengeluaran. co: Makan Pagi">
						</div>
